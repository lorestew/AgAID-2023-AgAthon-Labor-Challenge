...
<p align="left">
    ...
    <img width="25%" src="examples/Figure_7d1.png" style="max-width:20%;"></a>
    <img width="25%" src="examples/Figure_7d2.png" style="max-width:20%;"></a>
    <img width="25%" src="examples/Figure_7d3.png" style="max-width:20%;"></a>
    <img width="25%" src="examples/Figure_7d4.png" style="max-width:20%;"></a>
</p>
